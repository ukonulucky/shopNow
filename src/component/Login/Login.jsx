  ...
  return (
      <div className="login">
          ...
          <div className="login__container">
              ...
              <p>
                  please by signing in you agree to our terms and condition of sales and services. Please see our privacy notice, our interest based notice and our interest based Ads Notice. 
              </p>
              <button className="login__register"
              onClick={registerUser}>Create An Account</button>
          </div>
   </div>
  )
}
